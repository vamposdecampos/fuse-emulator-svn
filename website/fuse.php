...
href="ftp://ftp.worldofspectrum.org/pub/sinclair/emulators/unix/fuse-0.6.2.1.tar.gz.sig">signature</a>), <a href="ftp://ftp.worldofspectrum.org/pub/sinclair/emulators/unix/fuse-utils-0.6.2.tar.gz">utils source</a> (<a href="ftp://ftp.worldofspectrum.org/pub/sinclair/emulators/unix/fuse-utils-0.6.2.tar.gz.sig">signature</a>).</li>
  ...
  <ul>
   <li>Unofficial packages for <a href="http://www.debian.org/">Debian</a>, by Darren Salt: either <a href="http://www.youmustbejoking.demon.co.uk/progs.stable.html">stable</a> (0.6.1.1) or <a href="http://www.youmustbejoking.demon.co.uk/progs.unstable.html">unstable</a> (0.6.2.1).</li>
   ...
   <li><a href="http://www.gentoo.org/">Gentoo</a> users have an <a href="http://packages.gentoo.org/packages/?category=app-emulation;name=fuse">ebuild</a> of 0.6.2.1 available.</li>
   <li>Miguel Barrio Orsikowsky has made <a href="http://www.speccy.org/sinclairmania/arch/emu/mandrake/">Mandrake packages</a> of version 0.6.1.1 (for Mandrake 9.1 and 9.2) and version 0.6.2.1 (for Mandrake 10.0) available, as well as some of the libraries needed by Fuse such as lib765 and libdsk.</li>
   <li>Mac OS X: <a href="http://prdownloads.sourceforge.net/fuse-emulator/Fuse-0.6.2.1.dmg?download">Fuse binaries</a>, the slightly <a href="http://prdownloads.sourceforge.net/fuse-emulator/fuse-macosx-0.6.2.1.tar.bz2?download">modified Fuse source</a>, or the <a href="http://prdownloads.sourceforge.net/fuse-emulator/fuse-utils-macosx-0.6.2.tar.bz2?download">utilities binaries</a>. These are also mirrored at WoS: <a href="ftp://ftp.worldofspectrum.org/pub/sinclair/emulators/mac/osx/Fuse-0.6.2.1.dmg">Fuse</a>, <a href="ftp://ftp.worldofspectrum.org/pub/sinclair/emulators/mac/osx/Fuse-0.6.2.1-src.tar.bz2">Fuse source</a> or <a href="ftp://ftp.worldofspectrum.org/pub/sinclair/emulators/mac/osx/fuse-utils-0.6.2.tar.bz2">utilities</a>.</li>
