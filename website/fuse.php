...
fuse_section ("Requirements", "What do I need to run Fuse?", <<<END_SECTION
  ...
  <h3>Windows</h3>
  <p>A port to Windows by Marek Januszewski and Stuart Brady is available <a href="http://prdownloads.sourceforge.net/fuse-emulator/fuse-0.9.0-win32.zip?download">here</a> (<a href="http://prdownloads.sourceforge.net/fuse-emulator/fuse-0.9.0-win32.zip.sig?download">PGP signature</a>). This is also mirrored at <a href="http://www.worldofspectrum.org/">World of Spectrum</a>: <a href="ftp://ftp.worldofspectrum.org/pub/sinclair/emulators/pc/windows/fuse-0.9.0-win32.zip">Fuse</a> (<a href="ftp://ftp.worldofspectrum.org/pub/sinclair/emulators/pc/windows/fuse-0.9.0-win32.zip.sig">signature</a>).</p>
...
href="ftp://ftp.worldofspectrum.org/pub/sinclair/emulators/unix/fuse-0.9.0.tar.gz.sig">signature</a>), <a href="ftp://ftp.worldofspectrum.org/pub/sinclair/emulators/unix/fuse-utils-0.9.0.tar.gz">utils source</a> (<a href="ftp://ftp.worldofspectrum.org/pub/sinclair/emulators/unix/fuse-utils-0.9.0.tar.gz.sig">signature</a>).</li>
  ...
  <ul>
   ...
   <li>Zoran Jekic has produced <a href="http://www.suse.com">SuSE</a> 9.3 packages of <a href="fuse-0.9.0-1.zj.i586.rpm">0.9.0</a> and the <a href="fuse-utils-0.9.0-1.zj.i586.rpm">utilities</a>.</li>
  </ul>
